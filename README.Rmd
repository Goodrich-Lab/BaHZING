...
## Input Requirements
BaZING's formatting function requires a phyloseq object as the input. Ensure that your phyloseq object adheres to the required format. Refer to the phyloseq documentation for details on creating and manipulating phyloseq objects. 
...
The BaZING model function provides results from the Bayesian hierarchical zero-inflated negative binomial regression model.
