...
### Define counterfactuals based on a low and high exposure level in your data
counterfactual_profiles <- c(1,5) #1 serving to 5 servings

### If mixtures are not standardized, set to false 
standardized = FALSE

### If want to compare to results of qgcomp, set to true. If not, set to false
quantiles = FALSE

### Perform BaH-ZING 
results <- BaZING_Model(formatted_data,covar,x,counterfactual_profiles,standardized,quantiles)
```
